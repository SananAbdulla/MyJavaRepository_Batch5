...
//        System.out.println();
        ...
        System.out.println(countEachChars("Unitet State of America1"));

    }


    public static String countEachChars(String str) {
        int upperCaseCount = 0;
        int lowerCaseCount = 0;
        int numCount = 0;
        int otherCharCount = 0;
        ...
        return upperCaseCount + " uppercase letters" + "\n" + lowerCaseCount + " lowercase letters" + "\n" + numCount + " numbers" + "\n" + otherCharCount + " others";
