...
public class ShoppingList {
    public static void main(String[] args) {
        ...
        statusOfShoppingList(shoppingList);
        removeItemFromShoppingList(shoppingList,"eggs");
...
//        }
    ...
    public static void removeItemFromShoppingList(ArrayList<String> list, String itemName) {

        System.out.println(list.remove(itemName));
    }
