...
public class StringUtil {
     ...
     * @returns the character which occurs more than once
     * @author Sanan
     */

    public static String frequencyOfChars (String str, char letter) {
        ...
        return "given char have only " + count + " frequency";
    }
